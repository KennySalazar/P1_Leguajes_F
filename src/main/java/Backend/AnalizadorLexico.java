...
import Backend.analizador.Aritmeticos;
import Backend.analizador.ClaseError;
...
public class AnalizadorLexico {
    ...
    public ArrayList<Token> analizarCodigoFuente() {
        while (indice < codigoFuente.length()) {
            ...
            if (caracter == '\n') {
            ...
            } //EN ESTA PARTE VERIFICA SI VIENE UNA ASIGNACION DE MULTIPLICACION *=, O SOLO VIENE EL SIGO DE MULTI
            else if (caracter == '*') {
                StringBuilder lexema = new StringBuilder();
                lexema.append(caracter);
                columna++;
                ...
                try {
                    ...
                    if (caracter == '=') {
                        lexema.append(caracter);
                        columna++;
                        tokens.add(new Token(Token.Tipo.ASIGNACION, lexema.toString(), linea, columna));
                        indice += 2;
                    } else {
